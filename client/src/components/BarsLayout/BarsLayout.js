  ...
  render(){
    return(
        ...
        <div className="card">
          ...
          <h6 style={{marginTop:"-2px"}}><span>Bussiness Name: </span>{this.props.barName}</h6>
            <p><span>Address: </span>{this.props.street}<span style={{fontSize:"11px", color:"gray"}}>{this.props.type}</span></p>
